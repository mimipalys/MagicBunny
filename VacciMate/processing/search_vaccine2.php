...
<body>
    <div  class = "search_vaccine">
        <form action="search_vaccine1.php" method="GET">
...
if (isset($_GET['search_query'])) {
    ...
    echo '<a id = "GFG" href = "http://localhost:8888/processing/search_vaccine1.php" class="show-all-button"> Show all vaccines</a>';
    echo '</div>';
